...
<%--            내용 부분--%>
    <table class="table">
        ...
        <tbody>
        <tr>
            <td class="item1">${fileboard.articleno}</td>
        ...
        <tr>
            <td colspan="3">
                <c:forEach var="file" items="${fileboard2}">
                    <a href="${pageContext.request.contextPath}/resources/upload/${file.saveFolder}/${file.saveFile}" download="${file.originFile }"><i class="fas fa-file" style="color: #54c066;"></i> ${file.originFile }</a>
                </c:forEach>
            </td>
        </tr>
        </tbody>
